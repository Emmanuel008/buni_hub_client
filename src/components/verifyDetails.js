...
const VerifyDetails = () =>{
    const navigate = useNavigate()
      ...
      const handleSubmit = async (event) =>{ 
        ...
        try {
            console.log(values)
          const { first_name, last_name, email, role, location, phoneNumber } = values
        await axios.post('http://localhost:8081/api/member/verifyMember',{
    ...
    return (
      ...
      <div className="mx-auto container max-w-2xl md:w-3/4 shadow-md">
        <div className="bg-gray-100 p-4 border-t-2 bg-opacity-5 border-orange-400 rounded-t">
          <h2 className="font-semibold text-3xl text-orange-500">Verify Membership</h2>
        </div>
